              ...
              <div>
                <div className="flex flex-wrap items-center gap-3 mb-3">
                  ...
                  <div className="inline-flex items-center gap-2 flex-wrap">
                    ...
                    {isWideView && (
                      <div className="inline-flex items-center gap-3 rounded-lg border border-gray-200 bg-white px-3 py-2 shadow-sm">
                        <div className="text-[11px] font-semibold text-gray-700">Dimensiuni</div>
                        <div className="grid grid-cols-3 gap-1">
                          ...
                          <div className="flex items-center justify-center text-[10px] font-semibold text-gray-600 bg-gray-100 rounded px-1 py-0.5">
